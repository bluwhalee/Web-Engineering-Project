        ...
        while (orders.size() > val) {
            ...
            if (orders.get(val)[0].equals("Complete Repair")) {
                ...
                suc = oa.addorder(orders.get(val)[0], orders.get(val)[1], orders.get(val)[2], orders.get(val)[3],
                        orders.get(val)[4], orders.get(val)[5], "-", "-", "-", "-", "New", id,
                        Integer.parseInt(orders.get(val)[7]));
            ...
            if (orders.get(val)[0].equals("Cosmic Repair")) {
                ...
                int suc = 1;
                suc = oa.addorder(orders.get(val)[0], orders.get(val)[1], "-", "-", "-", "-", orders.get(val)[2],
                        orders.get(val)[3], orders.get(val)[4], orders.get(val)[5], "New", id,
                        Integer.parseInt(orders.get(val)[7]));
                out.println("suc: " + suc + "<br>");
            }
            val = val + 1;
